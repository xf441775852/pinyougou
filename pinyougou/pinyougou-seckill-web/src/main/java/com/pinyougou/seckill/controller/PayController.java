   ...
   private SeckillOrderService seckillOrderService;
    ...
    public Map createNative(){
        ...
        if (seckillOrder==null){
            ...
            return weixinPay.createNative(seckillOrder.getId()+"",fen+"");
        }
    }
    ...
    public Result queryPayStatus(String out_trade_no){
        ...
        while (true){
            //调用查询接口
            Map<String,String> map = weixinPay.queryPayStatus(out_trade_no);
            if (map==null){//出错
            ...
            if(x>20){
                ...
                //1.调用微信的关闭订单接口（学员实现）
                Map<String,String> payresult = weixinPay.closePay(out_trade_no);
