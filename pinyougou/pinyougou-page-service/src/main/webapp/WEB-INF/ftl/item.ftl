					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								<dd><a href="javascript:;" class="{{isSelected('${item.attributeName}','${value}')?'selected':''}}"
								ng-click="selectSpecificationItems('${item.attributeName}','${value}')">${value}<span title="点击取消选择">&nbsp;</span>
								</a></dd>
								</#list>
							</dl>
							</#list>
